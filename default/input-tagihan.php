                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-block">
                                                        <h4 class="sub-title">INPUT DATA PINJAMAN</h4>
                                                        <form method="POST" action="simpan-pinjam.php">
                                                            <div class="form-group row">
                                                                <label for="example-text-input" class="col-sm-2 col-form-label">Kode</label>
                                                                <div class="col-sm-8">
                                                                    <input name="kode" id="kode" type="text" class="form-control form-control-center" placeholder="Kode" value="<?= $kode ?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="example-text-input" class="col-sm-2 col-form-label">No. Antrian</label>
                                                                <div class="col-sm-8">
                                                                    <input name="no_antri" id="no_antri" type="text" class="form-control form-control-center" placeholder="No Antrian" value="<?= $no_antri ?>" readonly>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="example-text-input" class="col-sm-2 col-form-label">Nama Lengkap</label>
                                                                <div class="col-sm-8">
                                                                    <input name="nama" id="nama" type="text" class="form-control form-control-center" placeholder="Nama Lengkap">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="example-text-input" class="col-sm-2 col-form-label">Tanggal Pinjaman</label>
                                                                <div class="col-sm-8">
                                                                    <input name="tgl_pinjam" id="tgl_pinjam" class="form-control form-control-center" type="date" placeholder="Tanggal Pinjaman" />
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="example-text-input" class="col-sm-2 col-form-label">Nominal</label>
                                                                <div class="col-sm-8">
                                                                    <input name="jumlah_pinjam" id="jumlah_pinjam" type="text" class="form-control form-control-center" placeholder="Nominal">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="example-text-input" class="col-sm-2 col-form-label">Nomer Telp</label>
                                                                <div class="col-sm-8">
                                                                    <input name="telp" id="telp" type="text" class="form-control form-control-center" placeholder="No Telp">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="example-text-input" class="col-sm-2 col-form-label">Alamat</label>
                                                                <div class="col-sm-8">
                                                                    <input name="alamat" id="alamat" type="text" class="form-control form-control-center" placeholder="Alamat">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <input name="ket_pinjam" id="ket_pinjam" type="text" class="form-control form-control-center" placeholder="Keterangan">
                                                                </div>
                                                            </div>
                                                            <a href="input-tagihan.php?kode=<?php echo $row['kode']; ?>">
                                                                <button type="submit" class="btn btn-primary btn-sm" name="aksi1" value="simpan1">
                                                        ...
                                                        <div class="dt-responsive table-responsive">
                                                            <table id="simpletable" class="table table-striped table-bordered nowrap">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <td>
                                                                        <a href="pinjaman-edit.php?kode=<?php echo $data['kode']; ?>">
